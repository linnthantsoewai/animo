...
// Vibrant Material 3 Expressive Palette
// Primary: Indigo
// Secondary: Coral
// Tertiary: Teal

val md_theme_light_primary = Color(0xFF6750A4) // Vibrant Indigo
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFFEADDFF)
val md_theme_light_onPrimaryContainer = Color(0xFF21005D)

val md_theme_light_secondary = Color(0xFF9C4146) // Energetic Coral/Red-ish
val md_theme_light_onSecondary = Color(0xFFFFFFFF)
val md_theme_light_secondaryContainer = Color(0xFFFFDAD6)
val md_theme_light_onSecondaryContainer = Color(0xFF410002)

val md_theme_light_tertiary = Color(0xFF006C4C) // Playful Teal
...
val md_theme_light_background = Color(0xFFFFFBFF) // Warm neutral
